...
pub extern fn ic_print(s: [*c]const u8) void;
pub extern fn ic_println(s: [*c]const u8) void;
pub extern fn ic_printf(fmt: [*c]const u8, ...) void;
pub extern fn ic_vprintf(fmt: [*c]const u8, args: [*c]struct___va_list_tag_1) void;
pub extern fn ic_style_def(style_name: [*c]const u8, fmt: [*c]const u8) void;
pub extern fn ic_style_open(fmt: [*c]const u8) void;
pub extern fn ic_style_close() void;
pub extern fn ic_set_history(fname: [*c]const u8, max_entries: c_long) void;
pub extern fn ic_history_remove_last() void;
pub extern fn ic_history_clear() void;
pub extern fn ic_history_add(entry: [*c]const u8) void;
pub const struct_ic_completion_env_s = opaque {};
pub const ic_completion_env_t = struct_ic_completion_env_s;
pub const ic_completer_fun_t = fn (?*ic_completion_env_t, [*c]const u8) callconv(.C) void;
...
pub extern fn ic_add_completion_ex(cenv: ?*ic_completion_env_t, completion: [*c]const u8, display: [*c]const u8, help: [*c]const u8) bool;
pub extern fn ic_add_completions(cenv: ?*ic_completion_env_t, prefix: [*c]const u8, completions: [*c][*c]const u8) bool;
...
pub const ic_is_char_class_fun_t = fn ([*c]const u8, c_long) callconv(.C) bool;
pub extern fn ic_complete_word(cenv: ?*ic_completion_env_t, prefix: [*c]const u8, fun: ?*const ic_completer_fun_t, is_word_char: ?*const ic_is_char_class_fun_t) void;
pub extern fn ic_complete_qword(cenv: ?*ic_completion_env_t, prefix: [*c]const u8, fun: ?*const ic_completer_fun_t, is_word_char: ?*const ic_is_char_class_fun_t) void;
pub extern fn ic_complete_qword_ex(cenv: ?*ic_completion_env_t, prefix: [*c]const u8, fun: ?*const ic_completer_fun_t, is_word_char: ?*const ic_is_char_class_fun_t, escape_char: u8, quote_chars: [*c]const u8) void;
pub const struct_ic_highlight_env_s = opaque {};
pub const ic_highlight_env_t = struct_ic_highlight_env_s;
pub const ic_highlight_fun_t = fn (?*ic_highlight_env_t, [*c]const u8, ?*anyopaque) callconv(.C) void;
pub extern fn ic_set_default_highlighter(highlighter: ?*const ic_highlight_fun_t, arg: ?*anyopaque) void;
pub extern fn ic_highlight(henv: ?*ic_highlight_env_t, pos: c_long, count: c_long, style: [*c]const u8) void;
pub const ic_highlight_format_fun_t = fn ([*c]const u8, ?*anyopaque) callconv(.C) [*c]u8;
pub extern fn ic_highlight_formatted(henv: ?*ic_highlight_env_t, input: [*c]const u8, formatted: [*c]const u8) void;
pub extern fn ic_readline_ex(prompt_text: [*c]const u8, completer: ?*const ic_completer_fun_t, completer_arg: ?*anyopaque, highlighter: ?*const ic_highlight_fun_t, highlighter_arg: ?*anyopaque) [*c]u8;
pub extern fn ic_set_prompt_marker(prompt_marker: [*c]const u8, continuation_prompt_marker: [*c]const u8) void;
pub extern fn ic_get_prompt_marker() [*c]const u8;
pub extern fn ic_get_continuation_prompt_marker() [*c]const u8;
...
pub extern fn ic_enable_history_duplicates(enable: bool) bool;
pub extern fn ic_enable_auto_tab(enable: bool) bool;
pub extern fn ic_enable_completion_preview(enable: bool) bool;
...
pub extern fn ic_set_hint_delay(delay_ms: c_long) c_long;
pub extern fn ic_enable_highlight(enable: bool) bool;
pub extern fn ic_set_tty_esc_delay(initial_delay_ms: c_long, followup_delay_ms: c_long) void;
...
pub extern fn ic_completion_input(cenv: ?*ic_completion_env_t, cursor: [*c]c_long) [*c]const u8;
pub extern fn ic_completion_arg(cenv: ?*const ic_completion_env_t) ?*anyopaque;
pub extern fn ic_has_completions(cenv: ?*const ic_completion_env_t) bool;
pub extern fn ic_stop_completing(cenv: ?*const ic_completion_env_t) bool;
pub extern fn ic_add_completion_prim(cenv: ?*ic_completion_env_t, completion: [*c]const u8, display: [*c]const u8, help: [*c]const u8, delete_before: c_long, delete_after: c_long) bool;
pub extern fn ic_prev_char(s: [*c]const u8, pos: c_long) c_long;
pub extern fn ic_next_char(s: [*c]const u8, pos: c_long) c_long;
pub extern fn ic_starts_with(s: [*c]const u8, prefix: [*c]const u8) bool;
pub extern fn ic_istarts_with(s: [*c]const u8, prefix: [*c]const u8) bool;
pub extern fn ic_char_is_white(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_nonwhite(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_separator(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_nonseparator(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_letter(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_digit(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_hexdigit(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_idletter(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_char_is_filename_letter(s: [*c]const u8, len: c_long) bool;
pub extern fn ic_is_token(s: [*c]const u8, pos: c_long, is_token_char: ?*const ic_is_char_class_fun_t) c_long;
pub extern fn ic_match_token(s: [*c]const u8, pos: c_long, is_token_char: ?*const ic_is_char_class_fun_t, token: [*c]const u8) c_long;
pub extern fn ic_match_any_token(s: [*c]const u8, pos: c_long, is_token_char: ?*const ic_is_char_class_fun_t, tokens: [*c][*c]const u8) c_long;
pub extern fn ic_term_init() void;
pub extern fn ic_term_done() void;
pub extern fn ic_term_flush() void;
pub extern fn ic_term_write(s: [*c]const u8) void;
pub extern fn ic_term_writeln(s: [*c]const u8) void;
pub extern fn ic_term_writef(fmt: [*c]const u8, ...) void;
pub extern fn ic_term_vwritef(fmt: [*c]const u8, args: [*c]struct___va_list_tag_1) void;
pub extern fn ic_term_style(style: [*c]const u8) void;
pub extern fn ic_term_bold(enable: bool) void;
pub extern fn ic_term_underline(enable: bool) void;
pub extern fn ic_term_italic(enable: bool) void;
pub extern fn ic_term_reverse(enable: bool) void;
pub extern fn ic_term_color_ansi(foreground: bool, color: c_int) void;
pub extern fn ic_term_color_rgb(foreground: bool, color: u32) void;
pub extern fn ic_term_reset() void;
pub extern fn ic_term_get_color_bits() c_int;
pub extern fn ic_async_stop() bool;
pub const ic_malloc_fun_t = fn (usize) callconv(.C) ?*anyopaque;
pub const ic_realloc_fun_t = fn (?*anyopaque, usize) callconv(.C) ?*anyopaque;
pub const ic_free_fun_t = fn (?*anyopaque) callconv(.C) void;
pub extern fn ic_init_custom_alloc(_malloc: ?*const ic_malloc_fun_t, _realloc: ?*const ic_realloc_fun_t, _free: ?*const ic_free_fun_t) void;
pub extern fn ic_free(p: ?*anyopaque) void;
pub extern fn ic_malloc(sz: usize) ?*anyopaque;
pub extern fn ic_strdup(s: [*c]const u8) [*c]const u8;
...
pub const IC_VERSION = @as(c_int, 104);
pub const ic_completion_env_s = struct_ic_completion_env_s;
pub const ic_highlight_env_s = struct_ic_highlight_env_s;
